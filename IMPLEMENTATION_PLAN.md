...
- Decide the rendering approach against the UI's existing no-build-step, no-new-dependency constraint: a CDN-loaded charting library vs. hand-rolled Canvas/SVG bars.
